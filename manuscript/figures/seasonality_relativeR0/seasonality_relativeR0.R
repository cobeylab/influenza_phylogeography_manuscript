...
resultsDir = '../../analysis/seasonality_relativeR0/'
plotDir = './'

figure_width = 3.425 #PNAS (inches)
...
parNames = c('relativeR0','seasonalAmplitude')
...
plotDF = ddply(plotDF, .(relativeR0, seasonalAmplitude), summarise, tropicsAgLag = mean(antigenicLagAg1,na.rm=TRUE), tropicsTrunkPro = mean(trunkProportions, na.rm=TRUE))
...
pdf(paste(plotDir,'seasonality_relativeR0.pdf',sep=''), width = figure_width, height = figure_width * 0.65) #inches
