...
RELATIVER0S = np.linspace(0.75,1.25,steps)
SEASONALAMPLITUDES = np.linspace(0.0,0.25,steps)

NUM_RUNS = 20
totalJobs = NUM_RUNS*len(RELATIVER0S)*len(SEASONALAMPLITUDES)
...
def generateJobs():	
	...
	for relativeR0 in RELATIVER0S:
		for seasonalAmplitude in SEASONALAMPLITUDES:
