...
csvFiles = ['mutationSizeFlux','meanFluxRate','antigenicLagAG1','trunkProportions']

PARAMS = ['totalN', 'initialPrR', 'muPhenotype', 'meanStep', 'sdStep', 'relativeN', 'relativeTurnover', 'tropicFractionI0', 'relativeR0', 'seasonalAmplitude', 'betweenDemePro', 'initialTraitA','beta','smithConversion']
PARAM_TYPES = {
	'totalN' : 'INTEGER',
	'initialPrR' : 'REAL',
	'muPhenotype' : 'REAL',
...
if __name__ == "__main__":
	...
	comboDb.execute(
		"CREATE TABLE summary (runId INTEGER, key TEXT, value TEXT);"
	)
	...
	comboDb.execute("CREATE TABLE mutationSizeFlux (runId INTEGER, sideMuRate REAL, sideMuSize REAL, sideAgFlux REAL, trunkMuRate REAL, trunkMuSize REAL, trunkAgFlux REAL);")
	...
	comboDb.execute("CREATE TABLE prevalenceNorth (runId INTEGER, prevalence REAL, north REAL, tropics REAL, south REAL);")
