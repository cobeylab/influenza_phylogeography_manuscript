...
demeCount = 6; 
demes = {"tropics1","tropics2", "north1", "north2","south1","south2"}; 
spatialColors = {RGBColor[0.324, 0.609, 0.708],
    RGBColor[0.124, 0.609, 0.708],
    RGBColor[0.765, 0.728, 0.274], 
    RGBColor[1.0, 0.728, 0.274], 
    RGBColor[0.857, 0.131, 0.132],
    RGBColor[0.657, 0.131, 0.132]}; 
...
{meanDistTropics, meanDistNorth1, meanDistNorth2, meanDistSouth1, meanDistSouth2} = 
     Table[
...
{trunkProTropics, trunkProNorth1, trunkProNorth2, trunkProSouth1, trunkProSouth2} = 
